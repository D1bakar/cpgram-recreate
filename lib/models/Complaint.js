...
const complaintSchema = new mongoose.Schema(
  {
    ...
    trackOtp: { type: String, default: null },
    trackOtpExpiry: { type: Date, default: null },
    trackOtpAttempts: { type: Number, default: 0 },
    trackOtpRequestedAt: { type: Date, default: null },
    history: [
      {
